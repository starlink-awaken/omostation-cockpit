"""场景族 F1/F2/F3 数据源 — 从 scenario.py 拆出 (2026-08-26 SRP 行数门).

technical_radar / work_assistant / family_health 的取数实现,
scenario.py 通过 import 使用, 命令入口不变.
"""
...
# 2026-08-26: F1/F2/F3 数据源拆至 scenario_sources.py (SRP 行数门), 此处导入保持调用面不变
