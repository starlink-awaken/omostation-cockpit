...
GROUPS: list[tuple[str, str, list[CmdRow]]] = [
    (
        ...
        "bright_green",
        [
            CmdRow("quickstart", "环境核验 + 上手向导", "cockpit quickstart"),
            CmdRow("init", "同 quickstart", "cockpit init"),
    ...
    (
        ...
        "cyan",
        [
            CmdRow("research", "深度研究主题", 'cockpit research "主题"'),
    ...
    (
        ...
        [
            ...
            CmdRow("ssb", "SSB 签名链", "cockpit ssb …"),
            CmdRow("kems", "KEMS 域治理", "cockpit kems status"),
            CmdRow("agent-workflow", "Agent 治理流程 runner", "cockpit agent-workflow status"),
            CmdRow("agent", "workflow start/claim/verify/closeout", "cockpit agent status"),
        ],
    ),
    (
        "🤖 Agent / 战略 / 协作",
    ...
    (
        ...
        [
            ...
            CmdRow("model-driven", "模型驱动生命周期", "cockpit model-driven …"),
            CmdRow("code", "代码库分析 codeanalyze", "cockpit code …"),
