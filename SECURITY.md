...
If you discover a security vulnerability in Cockpit, please report it responsibly:
...
- CLI commands may modify runtime state; require explicit confirmation for destructive ops.
- Web dashboard must authenticate HITL actions.
